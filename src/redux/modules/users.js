...
// 액션 타입 정의
const GET_USERS_START = "redux-start/users/GET_USER_START"; // 깃헙 API 호출을 시작하는 것을 의미
const GET_USERS_SUCCESS = "redux-start/users/GET_USER_SUCCESS"; // 깃헙 API 호출에 대한 응답이 성공적으로 돌아온 경우
const GET_USERS_FAIL = "redux-start/users/GET_USER_FAIL"; // 깃헙 API 호출에 대한 응답이 실패한 경우
...
export function* usersSage() {
  yield takeEvery(GET_USERS_SAGA_START, getUsersSage);
}
